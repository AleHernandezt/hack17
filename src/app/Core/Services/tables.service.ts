...
//     // Return a promise that resolves with the Tables[] data
//     return new Promise((resolve, reject) => {
//       // Your data retrieval logic here
//       const tablesData: Tables[] = [
//         { id: 1, name: 'Table 1', price: 10.99, status: 'IN_STOCK' },
//         { id: 2, name: 'Table 2', price: 9.99, status: 'LOW_STOCK' },
//         { id: 3, name: 'Table 3', price: 12.99, status: 'OUT_OF_STOCK' },
